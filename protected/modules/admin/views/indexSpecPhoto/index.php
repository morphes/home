...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('index-spec-photo-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php echo CHtml::link('Добавить запись', array('/admin/indexSpecPhoto/create'), array('class' => 'primary btn')); ?>


<div class="well" style="margin-top: 10px;">
	ВНИМАНИЕ! Добавленные изображения начнут отображаться на главной странице
	только в том случае, когда для каждой акитвной ссылки будет указано
	не менее 4-х активных специалистов.
</div>


<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	'id'           => 'index-spec-photo-grid',
