...
class NewsController extends AdminController
{
        ...
        public function actionCreate()
        {
                ...
                if (isset($_POST['News'])) {
                        ...
                        $model->public_time = !empty($_POST['News']['public_time']) ? strtotime(@$_POST['News']['public_time']) : time();
        ...
        public function actionUpload()
        {
                ...
                $image->quality(85)->save(News::UPLOAD_IMAGE_DIR . $fname);

                $url = $this->createAbsoluteUrl('/' . News::UPLOAD_IMAGE_DIR . $fname);
