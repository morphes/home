...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
	...
	'columns' => array(
		...
		array(
			'name' => 'building_type_cnt',
			'value' => '"<a href=\"/'.$this->module->id.'/'.$this->id.'/prop/id/".$data->id."/key/building_type\">Тип объекта</a>: ".$data->building_type_cnt',
			'type' => 'raw'
		),
		array(
			'name' => 'style_cnt',
			'value' => '"<a href=\"/'.$this->module->id.'/'.$this->id.'/prop/id/".$data->id."/key/style\">Стиль</a>: ".$data->style_cnt',
			'type' => 'raw'
		),
		array(
			'name' => 'room_cnt',
			'value' => '"<a href=\"/'.$this->module->id.'/'.$this->id.'/prop/id/".$data->id."/key/room\">Помещение</a>: ".$data->room_cnt',
			'type' => 'raw'
		),
		array(
			'name' => 'color_cnt',
			'value' => '"<a href=\"/'.$this->module->id.'/'.$this->id.'/prop/id/".$data->id."/key/color\">Цвет</a>: ".$data->color_cnt',
			'type' => 'raw'
		),
		array(
			'class' => 'CButtonColumn',
