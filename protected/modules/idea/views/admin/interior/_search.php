<div class="row">
		...
		<?php echo $form->textFieldRow($model,'name',array('size'=>15)); ?>
		...
		<?php echo $form->dropDownListRow($model,'status', array('0' => 'Все')+Interior::getStatusName(), array('size' => 1)); ?>
		...
		<div class="clearfix">
			<label>Привязка товаров</label>
			<div class="input">
				<?php echo CHtml::checkBox('is_bind', $is_bind);?>
				<span>есть</span>
			</div>
		</div>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo CHtml::textField('prod_id', $prod_id); ?>
			</div>
		</div>

		<div class="clearfix">
			<label>Наличие помещения</label>
			<div class="input">
				<?php echo CHtml::dropDownList('room_id', $room_id, array('' => 'неважно') + $rooms); ?>
			</div>
		</div>
