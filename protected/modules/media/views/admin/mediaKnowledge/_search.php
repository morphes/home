...
?>
	...
	<?php echo $form->dropDownListRow($model,'status', array(''=>'')+MediaKnowledge::$statusNames, array('class'=>'span5')); ?>
	...
	<?php echo $form->dropDownListRow($model,'genre', array(''=>'')+MediaKnowledge::$genreNames, array('class'=>'span5')); ?>
