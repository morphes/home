 ...
 */
class Chain extends Catalog2ActiveRecord implements IUploadImage
{
	...
	public function search()
	{
        ...
        {
                $chain_stores = Yii::app()->dbcatalog2->createCommand()
        ...
        {
                $stores_ids = Yii::app()->dbcatalog2->createCommand()->select('store_id')->from('cat_chain_store')
                ...
                $store_vendor = Yii::app()->dbcatalog2->createCommand()
