 ...
 */
class CategoryRoom extends Catalog2ActiveRecord
{
	/**
	...
	public static function updateRooms($selected, $categoryId)
	{
		...
		Yii::app()->dbcatalog2->createCommand($sql)->bindParam(':cid', $categoryId)->execute();
	...
	public static function getSelectedRooms($categoryId)
	{
		...
		$data = Yii::app()->dbcatalog2->createCommand($sql)->bindParam(':cid', $categoryId)->queryColumn();
