...
class CategoryController extends AdminController
{
	...
	public function actionIndex($cid = null)
	{
        ...
        public function actionParentKeys($cid = null, $term = null)
        {
                ...
                $options = Yii::app()->dbcatalog2->createCommand("SELECT t.id, t.name, t.key FROM `cat_option` t WHERE t.key LIKE '" . CHtml::encode($term) . "%' AND t.category_id = " . $parent_cat->id)->queryAll();
                $results = array();
	...
	public function loadModel($id)
	{
        ...
        public function actionAcCategory($term)
        {
                ...
                $data = Yii::app()->dbcatalog2->createCommand("SELECT t.id, t.name FROM `cat_category` t WHERE t.name LIKE '" . CHtml::encode($term) . "%'")->queryAll();
                $results = array();
