...
class FoldersController extends FrontController
{
	...
	public function actionFolder($id)
	{
		...
		$this->render('//catalog2/folders/folder',
			array(
	...
	public function actionAjaxFolder()
	{
		...
		$html = $this->renderPartial('//catalog2/folders/_folder',
	...
	public function actionList()
	{
		...
		$this->render('//catalog2/folders/list', array('models' => $models));
	}
	...
	public function actionGetStoresByProductAjax()
	{
		...
		$html = $this->renderPartial('//catalog2/folders/_discountFoldersList',
			array('stores' => $stores,
			      'model' => $productModel
			), true);
