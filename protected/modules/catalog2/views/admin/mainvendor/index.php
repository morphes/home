...
$this->breadcrumbs=array(
	...
	'Главная товаров, список брендов',
);
...
<script type="text/javascript">
	...
	arrowsUpDown.init("main-vendor-grid", "/catalog2/admin/mainvendor/");
</script>

<h1>Главная товаров, список брендов</h1>
<!--  Context menu -->
...
<div>
	<?php echo CHtml::button('Добавить бренд', array('class'=>'primary btn','style'=>'float:right; margin-left: 10px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog2/admin/mainvendor/create/').'\''))?>
</div>

<?php
$dataProvider = $model->search();
$criteria = $dataProvider->getCriteria();
$criteria->compare('type_id', MainUnit::TYPE_VENDOR);
