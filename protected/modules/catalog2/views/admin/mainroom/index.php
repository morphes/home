...
<script type="text/javascript">
	...
	arrowsUpDown.init("main-room-grid", "/catalog2/admin/mainroom/");
</script>
...
<div>
	<?php echo CHtml::button('Добавить помещение', array('class'=>'primary btn','style'=>'float:right; margin-left: 10px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog2/admin/mainroom/create/').'\''))?>
</div>
