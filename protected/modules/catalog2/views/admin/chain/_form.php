        ...
        <?php if(!$model->isNewRecord) : ?>
                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
                        ...
                        'columns'=>array(
                                ...
                                array(
                                        ...
                                        'updateButtonUrl'=>'"/catalog2/admin/store/update/id/".$data->id',
                                        'deleteButtonUrl'=>'"/catalog2/admin/chain/deleteStore/chain_id/'.$model->id.'/store_id/".$data->id'
                                ),
                        ),
                )); ?>
                ...
                <?php Yii::app()->clientScript->registerScript('store', '
                        $("#button-add-store").click(function(){
                                ...
                                $.post("/catalog2/admin/chain/addStore", {store_id: sid, chain_id: cid}, function(response) {
                                        if(response.success)
        ...
        <?php if(!$model->isNewRecord) : ?>
                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
                        ...
                        'columns'=>array(
                                ...
                                array(
                                        ...
                                        'deleteButtonUrl'=>'"/catalog2/admin/chain/deleteVendor/chain_id/'.$model->id.'/vendor_id/".$data->id',
                                ),
                        ),
                )); ?>
                ...
                <?php Yii::app()->clientScript->registerScript('vendor', '
                        ...
                        $("#button-add-vendor").click(function(){
                                ...
                                $.post("/catalog2/admin/chain/addVendor", {chain_id: cid, vendor_id: vid}, function(response) {
                                        if(response.success)
