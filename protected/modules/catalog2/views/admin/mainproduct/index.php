...
$this->breadcrumbs=array(
	...
	'Главная товаров, список предложений',
);
...
<script type="text/javascript">
	...
	arrowsUpDown.init("main-product-grid", "/catalog2/admin/mainproduct/");
</script>

<h1>Главная товаров, список предложений</h1>
...
<div>
	<?php echo CHtml::button('Добавить предложение', array('class'=>'primary btn','style'=>'float:right; margin-left: 10px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog2/admin/mainproduct/create/').'\''))?>
</div>

<?php
$dataProvider = $model->search();
$criteria = $dataProvider->getCriteria();
$criteria->compare('type_id', MainUnit::TYPE_PRODUCT);
