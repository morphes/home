...
<script type="text/javascript">
	...
	arrowsUpDown.init("main-idea-grid", "/catalog2/admin/mainidea/");
</script>
...
<div>
	<?php echo CHtml::button('Добавить предложение', array('class'=>'primary btn','style'=>'float:right; margin-left: 10px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog2/admin/mainidea/create/').'\''))?>
</div>
