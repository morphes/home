...
$this->breadcrumbs=array(
	...
	'Главная товаров, список предложений'=>array('/catalog2/admin/mainidea/index'),
	'Добавление идеи',
);
?>
...
<div class="actions">
	...
	<?php echo CHtml::button('Отмена', array('class'=>'btn default','onclick' => "document.location = '".$this->createUrl('/catalog2/admin/mainidea/index')."'"));?>
</div>
...
<script type="text/javascript">
	...
	$('#show').click(function(){
		...
		$.ajax({
			url: 	'/catalog2/admin/mainidea/axgetcontent',
			dataType: 'json',
			type: 'post',
			data: {idea_id: ideaId},
			async: 	false,
