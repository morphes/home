...
<div>
        ...
        <?php /*echo CHtml::beginForm('/catalog2/admin/chain/addStores', 'get'); */?><!--
        ...
        <?php echo CHtml::button('Новый магазин', array('class'=>'primary btn','style'=>'float:right; margin-left: 10px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog2/admin/store/create/').'\''))?>
</div>
			...
			'htmlOptions' => array(
				'width' => '80px'
                        ...
                        'buttons'=>array(
                                'clone' => array(
                                        'label'=>'Клон',
                                        'url'=>'Yii::app()->createUrl("/catalog2/admin/store/clone", array("id"=>$data->id))',
                                ),
				'goods' => array(
					'label'=>'Товары',
					'url'=>'Yii::app()->createUrl("/catalog2/admin/store/goods", array("id"=>$data->id))',
				),
                                'stat' => array(
                                        'label'=>'Статистика',
					'imageUrl' => '/img/admin/small/statistics.png',
                                        'url'=>'Yii::app()->createUrl("/catalog2/admin/store/statistic", array("id"=>$data->id))',
                                ),
                        ),
                        'class'=>'CButtonColumn',
