...
<div class="actions">
	<?php echo CHtml::submitButton('Редактировать', array('class'=>'btn primary large', 'onclick'=>'document.location=\'/catalog2/admin/contractor/update/id/'.$model->id.'\''  )); ?>
	<?php echo CHtml::button('Удалить', array('class'=>'danger btn large','onclick' => 'if (!confirm("Удалить")) { return false; } else { document.location="/catalog2/admin/contractor/delete/id/'.$model->id.'" }')); ?>
	<?php echo CHtml::button('Статистика', array('class'=>'info btn large','onclick' => 'document.location=\'/catalog2/admin/contractor/statistic/id/'.$model->id.'\'')); ?>
