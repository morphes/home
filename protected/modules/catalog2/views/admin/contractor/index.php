...
<div>
	<?php echo CHtml::button('Добавить контрагента', array('class'=>'primary btn','style'=>'float:right; margin-top: -25px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog2/admin/contractor/create/').'\''))?>
</div>
	...
	'columns'=>array(
		...
		array(
			...
			'buttons'=>array(
				'stat' => array(
					'label'=>'Статистика',
					'url'=>'Yii::app()->getController()->createUrl("/catalog2/admin/contractor/statistic", array("id" =>$data->id))',
					'options'=>array('target'=>'_blanck'),
					'imageUrl'=>'/img/admin/small/statistics.png'
				),
				'csv' => array(
					'label'=>'CSV',
					'url'=>'Yii::app()->getController()->createUrl("/catalog2/admin/contractor/export", array("contractor_id" =>$data->id))',
