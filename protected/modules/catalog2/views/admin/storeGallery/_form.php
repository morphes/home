<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class="clearfix">
		<label><?php echo StoreGallery::model()->getAttributeLabel('image_id');?></label>
		<div class="input">
			<?php $this->widget('ext.FileUpload.FileUpload', array(
				'url'         => $this->createUrl('imageUpload'),
				'postParams'  => array('gid' => $model->id),
				'config'      => array(
					'fileName'   => 'StoreGallery[file]',
			...
			<script>
				...
				$('#add-image').on('click', '.image_delete', function(){
					$.ajax({
						url: '/catalog2/admin/storeGallery/imageDelete',
						data: {
							gid: '<?php echo $model->id;?>',
	...
	<?php echo $form->textareaRow($model,'description',array('rows' => 10, 'class'=>'span8','maxlength'=>2000)); ?>

	<?php echo $form->dropDownListRow($model, 'status', array('' => '') + StoreGallery::$statuses, array('class' => 'span5')); ?>
