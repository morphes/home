...
<div class="row product-dialog-store-item" style="margin-bottom: 15px;">
	...
	<div class="span1">
		<?php echo CHtml::link('#' . $data->id, $this->createUrl('/catalog/admin/store/update', array('id'=>$data->id)), array('target'=>'_blank')); ?>
	</div>
	...
	<div class="span1">
		<?php $url = $this->createUrl('/catalog/admin/product/ajaxProductStoreBindPrice', array('store_id'=>$data->id, 'product_id'=>$pid)); ?>
