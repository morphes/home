...
<div class="row">
        ...
        <?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
                'action'=>Yii::app()->createUrl('/catalog/admin/category/index'),
                'method'=>'get',
        )); ?>
        ...
        <div class="clearfix">
                ...
                <div class="input">
                        <?php
                        $category = Yii::app()->db->createCommand()->select('name')->from('cat_category')->where('id=:id', array(':id'=>(int)$model->category_id))->limit(1)->queryScalar();
