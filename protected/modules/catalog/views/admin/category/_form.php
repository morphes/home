...
<?php else : ?>
        ...
        <?php Yii::app()->clientScript->registerScript('option-add', '
                ...
                $(".values-add").live("click", function(){
                        ...
                        $.ajax({
                                url: "/catalog/admin/category/optionValueCreate",
                ...
                $(".type-switch").live("change", function(){
                        ...
                        $.ajax({
                                url: "/catalog/admin/category/getTypeParams",
                ...
                $(".category-option-delete").live("click", function(){
                        ...
                        var ignore_warn = $this.attr("ignore_warn");
                        $.ajax({
                                url: "/catalog/admin/category/optionDelete",
                ...
                $(".category-value-delete").live("click", function(){
                        ...
                        $.ajax({
                                url: "/catalog/admin/category/valueDelete",
                ...
                $(".group-add").click(function(){
                        ...
                        $.ajax({
                                url: "/catalog/admin/category/groupCreate",
                ...
                $(".group_delete").live("click", function(){
                        ...
                        var $this = $(this);
                        $.ajax({
                                url: "/catalog/admin/category/groupDelete",
                ...
                $(".filterable-option input:checkbox").live("change", function(){
                        ...
                        if(type_id == 9) {
                                ...
                                var oid = td.attr("oid");
                                $.ajax({
                                        url: "/catalog/admin/category/sizeOptionFilterCheck",
