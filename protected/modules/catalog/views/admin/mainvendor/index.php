...
<script type="text/javascript">
	...
	arrowsUpDown.init("main-vendor-grid", "/catalog/admin/mainvendor/");
</script>
...
<div>
	<?php echo CHtml::button('Добавить бренд', array('class'=>'primary btn','style'=>'float:right; margin-left: 10px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog/admin/mainvendor/create/').'\''))?>
</div>
