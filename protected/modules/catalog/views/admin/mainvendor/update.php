...
$this->breadcrumbs=array(
	...
	'Главная товаров, список брендов'=>array('/catalog/admin/mainvendor/index'),
...
<div class="clearfix span9">
	...
	$this->widget('ext.NestedDynaTree.NestedDynaTree', array(
		'modelClass' => 'Category',
		'ajaxController' => '/catalog/admin/mainvendor/',
...
<div class="actions">
	...
	<?php echo CHtml::button('Отмена', array('class'=>'btn default','onclick' => "document.location = '".$this->createUrl('/catalog/admin/mainvendor/index')."'"));?>
</div>
