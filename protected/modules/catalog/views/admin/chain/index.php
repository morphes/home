...
<div>
        <?php echo CHtml::button('Новая сеть магазинов', array('class'=>'primary btn','style'=>'float:right; margin-left: 10px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog/admin/chain/create/').'\''))?>
</div>
