...
<div class="actions">
	...
	<?php echo CHtml::button('Отмена', array('class'=>'btn default large','onclick' => 'document.location = "/catalog/admin/contractor/view/id/'.$model->id.'"'));?>
	<?php echo CHtml::button('Удалить', array('class'=>'danger btn','onclick' => 'if (!confirm("Удалить")) { return false; } else { document.location="/catalog/admin/contractor/delete/id/'.$model->id.'" }')); ?>
</div>
