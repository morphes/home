...
<script type="text/javascript">
	...
	arrowsUpDown.init("main-product-grid", "/catalog/admin/mainproduct/");
</script>
...
<div>
	<?php echo CHtml::button('Добавить предложение', array('class'=>'primary btn','style'=>'float:right; margin-left: 10px;', 'onclick'=>'document.location = \''.$this->createUrl('/catalog/admin/mainproduct/create/').'\''))?>
</div>
