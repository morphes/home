...
class ContractorController extends AdminController
{
	...
	public function actionStatistic($id)
	{
		...
		$data = Yii::app()->db->createCommand($sql)->bindParam(':cid', $id)->bindParam(':st', $status)->queryAll();
	...
	public function actionExport()
	{
		...
		$idList = Yii::app()->db->createCommand($sql)->bindParam(':cid', $id)->queryColumn();
