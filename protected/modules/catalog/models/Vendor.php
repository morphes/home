 ...
 */
class Vendor extends EActiveRecord
{
	...
	public function search()
	{
        ...
        {
                return Yii::app()->createUrl('/catalog/vendor', array('id'=>$id, 'action'=>'index'));
        }
...
//		$criteria->group = 'vendor_id';
        ...
        {
                $categories_ids = Yii::app()->db->createCommand()->select('t.id')->from('cat_category t')
        ...
        {
                $stores_ids = Yii::app()->db->createCommand()->select('store_id')->from('cat_store_vendor')
