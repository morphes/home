 ...
 */
class CatFolders extends EActiveRecord implements IUploadImage
{
	...
	{
		return Yii::app()->createUrl('/catalog/folders/folder/id/'.$this->id);
	}
	...
	public function getPreview($config)
	{
		...
		if ( empty($this->image_id) ) {
			...
			$data = Yii::app()->db->createCommand($sql)->bindParam(':fid', $folderId)->queryRow();
	...
	public function getPhotos()
	{
		...
		$data = Yii::app()->db->createCommand($sql)->bindParam(':fid', $folderId)->queryAll();
