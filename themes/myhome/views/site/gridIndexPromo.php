			...
			<div class="-grid">
				<div class="-col-9 -gutter-bottom-dbl -inset-bottom-hf">
					<h1 class="-gutter-null">
						...
						<div class="-drop-right"><a href="/products"><?php echo number_format($countGoods, 0, '.', ' ');?> <?php echo $goodsWordDeclension;?></a><span></span></div>
					</h1>
				</div>1
				...
				<ul class="-slider-content">
					<?php if (isset($activeTabId)) { ?>
						...
						?>
							<!-- slide 1 -->
							<li class="-slide">
								<a href="<?php echo $link?>"><img width="540"
																 height="390"
