    ...
    <div class="step-1">
        <div class="-col-4 -skip-3 -inset-top -inset-bottom -gutter-top-dbl">
            ...
            <ul class="-menu-inline spec-type">
                <li data-id="<?php echo User::ROLE_USER; ?>" class="current">Заказчик</li>
                <li data-id="<?php echo User::ROLE_SPEC_JUR; ?>">Исполнитель</li>
            </ul>
        </div>
        <div class="-col-3">
            ...
            <form id="regForm_1" method="post" action="">
                <div>
                    <?php echo CHtml::activeTextField($user, 'firstname', array(
                        ...
                        'data-alt' => 'Название компании1',
                        'class' => '-huge'
                    )) ?>
                    <?php echo CHtml::activeHiddenField($user, 'role', array('value' => User::ROLE_USER)); ?>
                </div>
                <div>
                    <?php echo CHtml::hiddenField('User[city_id]', $user->city_id, array('id' => 'r_city_id')); ?>
                    <input type="text" placeholder="Город" class="-huge city-autocomplete" id="User_city_id"
                ...
                <button type="submit"
                        class="-button -button-skyblue -gutter-bottom-dbl -huge -semibold next become-specialist">Далее
                </button>
            </form>
        </div>
    </div>
    <div class="step-2">
        ...
        <div class="-col-7 -inset-bottom -hidden">
            <form id="regForm_2" method="post" action="">
                ...
                <div class="-inset-top-dbl -gutter-bottom-hf -gray">Регистрируясь, я соглашаюсь с <a href="/agreement"
                                                                                                     target="_blank"
