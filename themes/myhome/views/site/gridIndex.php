...
<div class="-col-12 spec-promo">
	<h1 style="margin-top: 30px">
		...
		<div class="-drop-right"><a href="/specialist"><?php echo number_format($countDesigner, 0, '.', ' ');?> <?php echo $designerWordDeclension;?> </a><span></span></div></h1>
	<div class="-grid">
		...
		<?php if (
			...
			foreach ($spec as $s) {
				...
				for ($i  = 0; $i < 4; $i++) {
					...
					$item = $s['photos'][$i];
					$htmlOut .= '<a class="spec-thumb" href="'.$item['user_url'].'"><img src="'.$item['user_img'].'"></a>';
				}
				$htmlOut .= '</div>';
			}
		...
		<?php } else { ?>
			...
			<div class="-col-3">
				...
				<a class="spec-thumb" href="http://www.myhome.ru/users/mashyny_m"><img src="/img-new/tmp/index/spec/1.jpg"></a>
				<a class="spec-thumb" href="http://www.myhome.ru/users/Melnich_vlad"><img src="/img-new/tmp/index/spec/2.jpg"></a>
				<a class="spec-thumb" href="http://www.myhome.ru/users/elachin"><img src="/img-new/tmp/index/spec/3.jpg"></a>
			...
			<div class="-col-3">
				...
				<a class="spec-thumb" href="http://www.myhome.ru/users/georgboyko"><img src="/img-new/tmp/index/spec/5.jpg"></a>
			...
			<div class="-col-3">
				...
				<a class="spec-thumb" href="http://www.myhome.ru/users/Santey"><img src="/img-new/tmp/index/spec/10.jpg"></a>
				<a class="spec-thumb" href="http://www.myhome.ru/users/rso2000"><img src="/img-new/tmp/index/spec/11.jpg"></a>
				<a class="spec-thumb" href="http://www.myhome.ru/users/dekor75"><img src="/img-new/tmp/index/spec/12.jpg"></a>
			</div>
			<!-- eof col 3 -->
...
<div class="-col-12 ideas-promo">
	<h1 class="-gutter-null">
		...
		<div class="-drop-left"><a href="/idea"><?php echo Idea::getIdeasPhotoQuantity(false, true);?> фото</a><span></span></div></h1>
	<!-- ideas-menu (ajax) -->
	...
	<ul class="-menu-inline -tab-menu -justified-menu -huge ideas-menu">
		...
		if (!empty($links) && count($links) >= 6) {
			...
			<li><a href="/idea/catalog/index?ideatype=2&object_type=118">Дома, коттеджи</a>&nbsp;&nbsp;и&nbsp;&nbsp;<a href="/idea" class="-pointer-right -gutter-right-null -red">многое другое</a></li>
			<?php
		}
		?>
	...
	$ideas = IndexIdeaPhoto::getPhotos();
	?>
	<div class="-grid ideas-thimbnails">
		...
		<?php if (!empty($ideas) && count($ideas) == 6) { ?>
			...
			<?php foreach ($ideas as $idea) { ?>
				<div class="-col-4 idea-thumb">
					<a href="<?php echo $idea['idea_url'];?>"><img src="<?php echo $idea['img_src'];?>" class="-rect-giant"></a>
					<div>
						<a class="-huge -semibold" href="<?php echo $idea['idea_url'];?>"><?php echo $idea['idea_name'];?></a>
						...
						<?php } else { ?>
							...
							<span class="-small -gutter-top-hf">
								<a class="-gray" href="<?php echo $idea['author_url'];?>"><img src="<?php echo $idea['author_img'];?>" class="-quad-25 -push-left -gutter-right-hf"><?php echo $idea['author_name'];?></a>
							</span>
		...
		<?php } else { ?>
			...
			<!-- idea-thumb -->
			<div class="-col-4 idea-thumb">
				<a href="http://www.myhome.ru/idea/interior/10066"><img src="/img-new/tmp/index/1.jpg" class="-rect-giant"></a>
				<div>
			...
			<!-- eof idea-thumb -->
			<div class="-col-4 idea-thumb">
				<a href="http://www.myhome.ru/idea/interior/9835"><img src="/img-new/tmp/index/2.jpg" class="-rect-giant"></a>
				<div>
			...
			<div class="-col-4 idea-thumb">
				<a href="http://www.myhome.ru/idea/interior/9732"><img src="/img-new/tmp/index/3.jpg" class="-rect-giant"></a>
				<div>
					<a class="-huge -semibold" href="http://www.myhome.ru/idea/interior/9732">Лофт для творческой личности</a>
					<span class="-small -gutter-top-hf"><span class="-gray">Редакция MyHome</span></span>
				</div>
			</div>
			<div class="-col-4 idea-thumb">
				<a href="http://www.myhome.ru/idea/interior/10075"><img src="/img-new/tmp/index/4.jpg" class="-rect-giant"></a>
				<div>
			...
			<div class="-col-4 idea-thumb">
				<a href="http://www.myhome.ru/idea/interior/10084"><img src="/img-new/tmp/index/5.jpg" class="-rect-giant"></a>
				<div>
			...
			<div class="-col-4 idea-thumb">
				<a href="http://www.myhome.ru/idea/interior/8966"><img src="/img-new/tmp/index/6.jpg" class="-rect-giant"></a>
				<div>
...
<div class="-col-12 media-promo">
	<h1>
		...
		<div class="-drop-left"><a href="/journal">Журнал myhome</a><span></span></div></h1>
	<div class="-grid">
		<!-- title article -->
		<div class="-col-6">
			<div class="-relative">
				...
				?>
				<a href="<?php echo $bigKnow->getElementLink(); ?>"><img src="<?php echo $bigKnow->preview->getPreviewName(MediaKnowledge::$preview['crop_460x340']);?>" class="-rect-promo-medium"></a>
				<div class="thumb-overlay"><?php echo CHtml::link(
					...
					<span class="-block -small -gray -gutter-top-hf">
						...
						<a class="-gutter-left-qr" href="<?php echo $bigKnow->getSectionLink() . '?f_genre='.$bigKnow->genre;?>"><?php echo MediaKnowledge::$genreNames[$bigKnow->genre];?></a>
			...
			<ul class="-menu-block">
				...
				if (!empty($news)) {
					...
					foreach ($news as $new) {
						?>
						<li>
							<a class="-relative" href="<?php echo $new->getElementLink();?>"><img src="<?php echo $new->preview->getPreviewName(MediaNew::$preview['crop_60']);?>" class="-absolute -quad-60"><?php echo Amputate::getLimb($new->title, 30);?></a>
	...
	<div class="-grid">
		...
		<div class="-col-3">
			...
			<div class="-gutter-bottom">
				...
				<iframe src="//www.facebook.com/plugins/facepile.php?href=http%3A%2F%2Ffacebook.com%2Fmyhome.ru&amp;action&amp;size=small&amp;max_rows=2&amp;show_count=true&amp;width=220&amp;colorscheme=light" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:220px;" allowTransparency="true"></iframe>
