...
<div class="item <?php if(isset($highlight_id) && $data->id == $highlight_id) echo 'added'; ?>">
    ...
    <div class="status">
            ...
            <?php if($data->status == Product::STATUS_MODERATE) echo '<span class="moderation">На модерации <a href="'.Yii::app()->createUrl('/catalog2/profile/productUpdate', array('id'=>$data->id)).'"><i title="редактировать"></i></a></span>'; ?>
                ...
                <span class="deflect">Отклонен
                    <?php if($data->admin_comment) : ?>
                            <div class="notice">
                                ...
                                <?php echo CHtml::link('редактировать', Yii::app()->createUrl('/catalog2/profile/productUpdate', array('id'=>$data->id))); ?>
                            </div>
                    <?php endif; ?>
                    <a href="<?php echo Yii::app()->createUrl('/catalog2/profile/productUpdate', array('id'=>$data->id)); ?>"><i title="редактировать"></i>
                </span>
            <?php endif; ?>
    </div>
