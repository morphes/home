<?php $this->pageTitle = 'Товары — ' . $model->name . ' — Магазины — MyHome.ru'; ?>
...
<div class="shop_items">
        ...
        <div id="right_side" class="new_template">
                ...
                <div class="catalog_items_list">
                        ...
                        <?php $this->widget('zii.widgets.CListView', array(
                                ...
                                'itemView'=>'//catalog2/category/_productItem',
                                'viewData'=>array('store_id'=>$model->id),
                                'template'=>'{items}'
                        ));?>
        ...
        <div id="left_side" class="new_template">
            ...
            <ul class="menu_tabs">
                ...
                <?php if($nav_type == 'vendor') $class = 'current'; else $class = ''; ?>
                <li class="<?php echo $class; ?>" data-content="vendors"><span>Производители</span></li>
            </ul>
            <div class="clear"></div>
            <div class="red_menu">
                <ul>
...
<?php Yii::app()->clientScript->registerScript('feedback-form', '
        $(".drop_down ul li").click(function(){
                CCommon.setCookie("store_product_filter_pagesize", $(this).attr("data-value"), {expires:31*24*60*60, path:"/"});
                $("#refresh-form").submit();
        });
