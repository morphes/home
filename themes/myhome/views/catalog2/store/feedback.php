<?php $this->pageTitle = $model->name . ' — Отзывы — MyHome.ru'; ?>
...
<div class="product_card">
        ...
        <div class="buyers_opinion_header">
                <?php $this->widget('application.components.widgets.WStar', array(
                        ...
                        'votesQt'=>StoreFeedback::model()->count('store_id=:sid and parent_id=0', array(':sid'=>$model->id)),
                ));?>
        ...
        <div class="page_settings new">
                ...
                <div class="elements_on_page drop_down">
                        ...
                        <ul class="need_submit">
                                <?php foreach(Config::$storeFeedbackPageSizes as $key=>$item) : ?>
        ...
        <div class="page_settings bottom">
	...
	<?php echo CHtml::hiddenField('answer_create_url', '/catalog2/store/feedbackAnswer'); ?>
	<?php echo CHtml::hiddenField('answer_delete_url', '/catalog2/store/deleteFeedbackAnswer'); ?>

        <?php if ($model->isOwner(Yii::app()->user->id)) : ?>
...
<form method="get" action="<?php echo $this->createUrl('/catalog2/store/feedback', array('id'=>$model->id)); ?>" id="update-form"></form>
