...
<div class="-col-9 event-add-form -hidden">
	<?php $this->renderPartial('//catalog2/store/_moneyNewsPopup', array(
		'data' => new StoreNews()
	)); ?>
</div>
...
<script>
	$(function(){
		...
		$('body').on('change', '.picture_for_news', function(){
			...
			uploadFile(file, "/catalog2/store/AjaxMoneyNewsImageUpload", form.attr('data-newsId'), function(response){
