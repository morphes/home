                ...
                <div class="catalog_sections">
                    <?php
                        ...
                        foreach($model->categories as $category)
                                $cats[] = CHtml::link($category->name, $this->createUrl('/catalog2/vendor', array('id'=>$model->id, 'action'=>'products', 'category_id'=>$category->id)));
                        echo implode(', ', $cats);
                    ?>
                </div>
            </div>
        ...
        <div class="other_models">
            <h3 class="headline">Товары</h3>
                <span class="all_elements_link" style="display: inline;">
                        <?php echo CHtml::link('Все', $this->createUrl('/catalog2/vendor', array('id'=>$model->id, 'action'=>'products'))); ?>
                        <span>&rarr;</span>
                </span>
        ...
        <div class="stores_list">
            ...
            <ul class="">
                ...
                <?php foreach($cities as $city) : ?>
                        <?php $i++;?>
                        <li>
                            <?php echo CHtml::link($city['name'], $this->createUrl('/catalog2/vendor', array('id'=>$model->id, 'action'=>'storesInCity', 'cid'=>$city['id']))) . '(' . $city['qt'] . ')'; ?>
                        </li>
                        <?php if($i == 10) break; ?>
                <?php endforeach; ?>
            </ul>
            ...
            <span class="all_elements_link" style="display: inline;">
                <?php echo CHtml::link('Все города', $this->createUrl('/catalog2/vendor', array('id'=>$model->id, 'action'=>'stores'))); ?>
                <span>&rarr;</span>
            </span>
