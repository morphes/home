...
$cs->registerScriptFile('/js-new/catalog2.js');
		...
		<div class="-col-3">
			<div class="page-sidebar">
				...
				<ul class="level-1 -menu-block -light-gray -gutter-bottom-dbl">
					<?php if ($category->name != 'root') { ?>
						<li class="-icon-arrow-down level-1"><a href="/products">Все категории</a></li>
					<?php } ?>
				 ...
				 * -------------------------------------
				 */
				$this->widget('catalog2.components.widgets.CatFilter.CatFilter', array(
					'category' => $category,
					'selected' => $selected,
					'city'     => $city,
					'viewName' => 'filterGrid',
			...
			<?php if (!empty($data)) { ?>
				...
				<div class="-grid">
					<div class="-col-9">
						...
						<!-- sorting -->
						<?php // Блок сортировки
						$this->widget('catalog2.components.widgets.CatFilterSortGrid', array(
							'items'=>array(
