...
<div class="clear"></div>
	...
	<?php echo CHtml::hiddenField('answer_create_url', '/catalog2/product/feedbackAnswer'); ?>
	<?php echo CHtml::hiddenField('answer_delete_url', '/catalog2/product/deleteFeedbackAnswer'); ?>
