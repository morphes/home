...
<div class="-col-9">
	...
	<div class="content_block">
		...
		<div class="profile_info_conteiner">
			...
			<form action="#" class="form-profile form-social">
				<div class="shadow_block white profile_info">
					<h2>Аккаунты в социальных сетях</h2>
					<div class="inner">
						<?php /*if ( ($tw = Oauth::checkBindTwitter($user->id)) ) { ?>
                                                <p class="fp-social">
                                                        <a href="http://twitter.com/#!/<?php echo $tw->account_name;?>" class="fp-social-title"><img src="/img/tw.png" width="16" height="16" alt="">
                                                                <?php if ($tw->social_name) : echo $tw->social_name; else : ?>twitter.com/<?php echo $tw->account_name; endif; ?></a>
                                                        <a href="/oauth/unbindtwitter" class="fp-social-remove">Удалить</a>
                                                </p>
                                                <?php } else { ?>
                                                <p class="fp-social">
                                                        <span class="fp-social-title"><img src="/img/tw.png" width="16" height="16" alt="">Профиль в Twitter</span>
                                                        <a href="#" onclick="socialBind('/oauth/bindtwitter', 'Twitter'); return false;">Привязать</a>
                                                </p>
                                                <?php }*/ ?>
						...
						<?php if ( ($fb = Oauth::checkBindFacebook($user->id)) ) { ?>
							<p class="fp-social">
								<a href="http://www.facebook.com/profile.php?id=<?php echo $fb->account_name;?>" class="fp-social-title"><img src="/img/fb.png" width="16" height="16" alt="">
									<?php if ($fb->social_name) : echo $fb->social_name; else : ?>www.facebook.com/<?php echo $fb->account_name; endif;?></a>
								<a href="/oauth/unbindfacebook" class="fp-social-remove">Удалить</a>
							</p>
						<?php } else { ?>
							<p class="fp-social">
								<span class="fp-social-title"><img src="/img/fb.png" width="16" height="16" alt="">Профиль в Facebook</span>
								<a href="#" onclick="socialBind('/oauth/bindfacebook', 'Facebook'); return false;">Привязать</a>
							</p>
						<?php } ?>
						...
						<?php if ( ($vk = Oauth::checkBindVkontakte($user->id)) ) { ?>
							<p class="fp-social">
								<a href="http://vkontakte.ru/id<?php echo $vk->account_name;?>" class="fp-social-title"><img src="/img/vk.png" width="16" height="16" alt="">
									<?php if ($vk->social_name) : echo $vk->social_name; else : ?>vkontakte.ru/id<?php echo $vk->account_name; endif;?></a>
								<a href="/oauth/unbindvkontakte" class="fp-social-remove">Удалить</a>
							</p>
						<?php } else { ?>
							<p class="fp-social">
								<span class="fp-social-title"><img src="/img/vk.png" width="16" height="16" alt="">Профиль ВКонтакте</span>
								<a href="#" onclick="socialBind('/oauth/bindvkontakte', 'ВКонтакте'); return false;">Привязать</a>
							</p>
						<?php } ?>

						<?php if ( ($odkl = Oauth::checkBindODKL($user->id)) ) { ?>
							<p class="fp-social">
								<a href="http://odnoklassniki.ru/profile/<?php echo $odkl->account_name;?>" class="fp-social-title"><img src="/img/ok.png" width="16" height="16" alt="">
									<?php echo $odkl->social_name;?>
								</a>
								<a href="/oauth/unbindodkl" class="fp-social-remove">Удалить</a>
							</p>
						<?php } else { ?>
							<p class="fp-social">
								<span class="fp-social-title"><img src="/img/ok.png" width="16" height="16" alt="">Профиль в Одноклассниках</span>
								<a href="#" onclick="socialBind('/oauth/bindodkl', 'Одноклассники'); return false;">Привязать</a>
							</p>
						<?php } ?>
					</div>
				...
				<div class="shadow_block white profile_info">
					<h2>Аккаунты на других сайтах</h2>
					<div class="inner other_social">
						...
						<p>
							<a class="add add_other_social" href="#">Добавить ссылку на профиль<i></i></a>
						</p>
					</div>
				</div>
			</form>
