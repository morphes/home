...
<?php if ($countModels > 0): ?>
	<div class="favorite_item">
		<h3>Общественные интерьеры<span class="items_count quant_f"><?php echo $countModels;?></span></h3>
			...
			<div class="gallery-210">
				...
				<div class="item">
					...
					<div class="item_photo">
						<?php
							...
							if (isset(Config::$rolesAdmin[$proj->author->role]))
								$projectUrl = Yii::app()->createUrl("/idea/", array('interiorpublic' => $proj->id));
							else
								$projectUrl = Yii::app()->createUrl("/users/{$proj->author->login}/project/{$proj->service_id}/{$proj->id}?t=2");
						?>
					...
					<div class="item_descript">
						...
						<a class="item_name" href="<?php echo Yii::app()->createUrl("/users/{$proj->author->login}/project/{$proj->service_id}/{$proj->id}?t=2"); ?>">
							<?php echo $proj->name; ?>
						</a>
					</div>
