				...
				<div class="shadow_block white profile_info">
					...
					<div class="inner">
						...
						<ul class="checkbox-list">
							...
							<li>
								<label for="fn-new-ideacomment">
									<?php echo $form->checkBox($user->data, 'idea_comment_notify', array('id' => 'fn-new-ideacomment'));?>
									<?php echo $user->data->getAttributeLabel('idea_comment_notify');?>
								</label>
							</li>
							<li>
								<label for="fn-tender">
									<?php echo $form->checkBox($user->data, 'tender_notify', array('id' => 'fn-tender'));?>
									<?php echo $user->data->getAttributeLabel('tender_notify');?>
								</label>
							</li>
							<li>
