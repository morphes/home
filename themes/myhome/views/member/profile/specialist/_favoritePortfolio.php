...
<?php if ($countModels > 0): ?>
	<div class="favorite_item">
		<h3>Другие проекты<span class="items_count quant_f"><?php echo $countModels;?></span></h3>
			...
			<div class="gallery-210">
				...
				<div class="item">
					...
					<div class="item_photo">
						<a href="<?php echo Yii::app()->createUrl("/users/{$proj->author->login}/project/{$proj->service_id}/{$proj->id}"); ?>">
