...
<div class="-gutter-top-dbl -gutter-bottom-dbl">
	<div class="stat-period __error">
		<input value="<?php echo $timeFrom; ?>" type="hidden"
		       name="">
		<input value="<?php echo date("d.m.y",$timeFrom); ?>" type="text"
		       class="-col-2 -large -gutter-null first-day"><i class="-icon-calendar -icon-gray -icon-only toggle-calendar"></i>
		<span class="-large -gray -inset-left-hf -inset-right-hf">—</span>
		<input value="<?php echo $timeTo; ?>" type="hidden"
		       name="" ">
		<input value="<?php echo date("d.m.y",$timeTo); ?>" type="text"
		       class="-col-2 -large -gutter-null last-day"><i class="-icon-calendar -icon-gray -icon-only toggle-calendar"></i>
	</div>
	<span class="-hidden"><i class="-icon-alert -icon-red"></i>Диапазон дат указан неверно</span>
</div>
<div class="-grid -force-middle stat-content">
<div class="stat-rows">
	<div class="-col-3">
