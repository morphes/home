...
<div class="favorite_item">
	<h3>Знания<span class="items_count quont_f"><?php echo $countModels;?></span></h3>
		...
		<div class="knowledge_items list">
			...
			<div class="item" id="<?php echo $data->id;?>">
				<div class="item_image">
					<i title="<?php echo MediaKnowledge::$genreNames[$data->genre];?>" class="genre <?php echo MediaKnowledge::$genreCssClass[$data->genre];?>"></i>
					<a href="<?php echo $data->getElementLink();?>"><img src="/<?php echo $data->preview->getPreviewName(MediaKnowledge::$preview['crop_160x110']);?>"/></a>
				</div>
				<div class="descript">
