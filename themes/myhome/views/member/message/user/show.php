...
<div class="messages-list">
	...
	<div class="item hover" id="msg-body-<?php echo $msg->id ?>">
		<div class="author">
			<p>
				<?php
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<p class="col1">
			...
			<label class="for_file" for="attach_file">Прикрепить
				изображение:</label>
		</p>
		<div class="col2">
			...
			<div class="input_conteiner">
				<?php  $this->widget('CMultiFileUpload',
					array(
						...
						'htmlOptions' => array('class' => 'img_input'),
						'options' => array(
			...
			<div class="btn_conteiner yellow">
				<input type="submit" class="btn_grey" value="Отправить">
			</div>
		</div>
