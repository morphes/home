...
<head>
	...
	$cs->registerCssFile('/css-new/generated/bm.css');
...
if (!empty($this->bodyClass)) {
	...
	foreach($this->bodyClass as $class) { echo $class.' ';}
} ?>">
...
<div class="-layout-page">
	...
	<script>
		CCommon.toggleMyhomeHeadder()
	</script>
	<div class="-grid-wrapper">
		<div class="-grid-container -header -gutter-top-dbl">
			<div class="-grid-wrapper title-image">

			</div>
			<div class="-grid-container -header">
				<div class="-col-6">
					<a href="<?php echo Yii::app()->params->bmHomeUrl; ?>">
						<img src="/img-new/bm/bm-logo.png">
					</a>
				</div>
				<div class="-col-3">
					<ul class="-menu-block">
						<li><a class="<?php if ($this->id=='category') echo 'current' ?>" href="/">Товары</a></li>
						<li><a class="<?php if ($this->id=='folders') echo 'current' ?>" href="/catalog/folders/list">Спецпредложения</a></li>
						<li><a class="<?php if ($this->id=='site') echo 'current' ?>" href="/about">Контакты</a></li>
					</ul>
				</div>
				<div class="-col-2">
				<span>
					...
					<a href="http://www.medvediza.ru" target="_blank">medvediza.ru</a>
				</div>
			</div>
...
<div class="-grid-container -layout-footer">
	<div class="-grid-wrapper">
		<div class="-grid">
			...
			<div class="-col-3">
				<p class="-small -gray">ООО &laquo;Май Хоум&raquo;, 2011&#150;<?php echo date('Y'); ?><br>Все права
					защищены, 12+</p>

				<p class="-small -gray">Использование материалов myhome.ru без разрешения редакции сайта
