...
<head>
	...
	<?php if (isset($this->canonicalUrl) && !empty($this->canonicalUrl)) { ?>
	...
	if ( !in_array($this->getRoute(), array('site/index', 'member/favorite/shared')) ) {
				...
				<noindex>
					...
					<div class="-footer-counters">
						<?php if (empty(Yii::app()->params->stopStatistic)) : ?>
							...
							<div class="-small"><noindex><a href="http://www.rambler.ru/"  rel="nofollow" target="_blank" style="color: #3f3f3f !important;">Партнер «Рамблера»</a></noindex></div>
						<?php endif; ?>
					</div>
				</noindex>
			</div>
