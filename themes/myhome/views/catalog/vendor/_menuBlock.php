        ...
        <?php $this->widget('zii.widgets.CMenu',array(
                ...
                'items'=>array(
                        array(
                                ...
                                'url'=>$this->createUrl('/catalog/vendor', array('id'=>$model->id, 'action'=>'index')),
                                'active' => $this->id == 'vendor' && $this->action->id == 'index',
                        ),
                        array(
                                'label'=>$seoText.'Товары',
                                'url'=>$this->createUrl('/catalog/vendor', array('id'=>$model->id, 'action'=>'products')),
                                'active' => $this->id == 'vendor' && $this->action->id == 'products',
                        ),
                        array(
                                'label'=>$seoText.'Магазины',
                                'url'=>$this->createUrl('/catalog/vendor', array('id'=>$model->id, 'action'=>'stores')),
