...
<script type="text/javascript">
    $(document).ready(function () {
		...
		<?php if ( count(Store::getOwnedStores(Yii::app()->user->id)) > 0 ) : ?>
		    <a class="btn_grey in_process" id="create_product" href="/catalog/profile/productSelectCategory">Добавить новый товар</a>
		    <div class="notice hide">
			    ...
			    <a href="#" id="continue_update" class="complete">Продолжить создание</a> или <a href="/catalog/profile/productSelectCategory">добавить новый товар</a>?
		    </div>
		<?php else : ?>
...
<div class="-hidden">
	<div class="-white-bg -inset-all -col-7" id="popup-store-alert">
		<div class="-gutter-bottom">
			...
			<button class="-button -button-skyblue" onclick="document.location.href = '/catalog/profile/storeCreate'; return false;">Создать магазин</button>
