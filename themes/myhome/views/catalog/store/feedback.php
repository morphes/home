...
<div class="product_card">
	...
	<?php echo CHtml::hiddenField('answer_create_url', '/catalog/store/feedbackAnswer'); ?>
	<?php echo CHtml::hiddenField('answer_delete_url', '/catalog/store/deleteFeedbackAnswer'); ?>
...
<form method="get" action="<?php echo $this->createUrl('/catalog/store/feedback', array('id'=>$model->id)); ?>" id="update-form"></form>
