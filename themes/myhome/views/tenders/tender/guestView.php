<div class="pathBar">
    ...
    <div class="tender_head_info">
        <span class="tender_date"><?php echo Yii::app()->getDateFormatter()->format('Размещен d MMMM yyyy в HH:mm', $tender->create_time); ?></span>
        |
        <span class="view_counter"><?php echo CFormatterEx::formatNumeral($viewsCount, array('просмотр', 'просмотра', 'просмотров')); ?></span>
    </div>
</div>
<div id="left_side">
...
<div id="right_side">
    ...
    <div class="authorization_error shadow_block padding-18 pink">
        Чтобы получить больше возможностей в работе с заказами, <a class="-login" href="#">авторизуйтесь</a> или <a
                class="register_guest" href="/site/registration">зарегистрируйтесь</a>
    </div>
