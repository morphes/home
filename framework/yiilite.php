	...
	protected function open()
	{
		if($this->_pdo===null)
		{
			...
			catch(PDOException $e)
			{
				if(YII_DEBUG)
				{
					throw new CDbException('CDbCon123nection failed to open the DB connection: '.
						$e->getMessage(),(int)$e->getCode(),$e->errorInfo);
				}
				else
				{
					Yii::log($e->getMessage(),CLogger::LEVEL_ERROR,'exception.CDbException');
					throw new CDbException('CDbConne432ction failed to open the DB connection.',(int)$e->getCode(),$e->errorInfo);
				}
			}
		}
	}
